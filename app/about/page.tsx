...
export const metadata: Metadata = {
  title: '소개 | DevNest',
  description: 'DevNest 블로그 - 프론트엔드 개발자 김관응의 개발 여정',
};
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <a href="mailto:kwaneung.kim@outlook.com" className="btn btn-soft btn-primary gap-2">
                <svg
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section className="stats stats-vertical lg:stats-horizontal shadow-lg w-full">
          ...
          <div className="stat place-items-center">
            ...
            <div className="stat-value text-secondary">3.6K</div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="card bg-base-100 shadow-xl border border-base-content/5">
              <div className="card-body">
                <h3 className="card-title text-accent">Tools & Others</h3>
                <div className="flex flex-wrap gap-2 mt-4">
        ...
        <section className="card bg-gradient-to-br from-base-100 to-base-200 shadow-xl border border-base-content/5">
          <div className="card-body space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/posts" className="btn btn-soft btn-primary">
                글 보러가기
              </Link>
              <a href="mailto:kwaneung.kim@outlook.com" className="btn btn-soft">
                문의하기
              </a>
            </div>
          </div>
